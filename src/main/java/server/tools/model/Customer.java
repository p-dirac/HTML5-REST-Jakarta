...
/**
 * Java object Customer maps to customers database table
 * 
...
public class Customer {
	...
	public String toString() {
		return "Customer [id=" + id + ", lastName=" + lastName + ", firstName=" + firstName + ", phone=" + phone
    ...
    public boolean equals(Object obj) {
        ...
        return id == other.id && Objects.equals(lastName, other.lastName) && Objects.equals(email, other.email);
    }
